package core.util.platform.android;
...
public class AndroidFileHelper {
    ...
    private static final Logger LOGGER = LogManager.getLogger(AndroidFileHelper.class);
    ...
    private String adbCommand = "adb -s ";
    private final String deviceID;

    public AndroidFileHelper(String deviceID) {
