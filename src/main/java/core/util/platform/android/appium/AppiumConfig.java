package core.util.platform.android.appium;

public enum AppiumConfig {
    APPIUM_CONFIG_FILE_PATH("core/android/appium.yaml"),
    APPIUM_DIRECTORY_CONFIG_FILE_PATH("core/android/appium-directory-%s.yaml"),
